...
All notable updates to the Cognitive Architecture publish vault will be documented in this file.

The format follows the guidance from [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) and uses date-based releases.

## 2025-11-12
### Added
- Created `Meta/Operations/` as the home for operational and publishing meta-notes.
- Added the Obsidian Publish alignment checklist (`Meta/Operations/Publish Alignment Plan.md`).
- Introduced repository-level `README.md` outlining structure and workflow guidance.
